...
Song.create(url: 'https://genius.com/Cardi-b-bodak-yellow-lyrics', name: 'Bodak Yellow', artist_id: Artist.find_by_name("Cardi B").id)
    ...
    Song.create(url: 'https://genius.com/Childish-gambino-iv-sweatpants-lyrics', name: 'Sweatpants', artist_id:
      Artist.find_by_name("Childish Gambino").id)


      Artist.create(name: 'Chance the Rapper')
      Song.create(url: 'https://genius.com/Chance-the-rapper-no-problem-lyrics', name: 'No Problem', artist_id:
        Artist.find_by_name("Chance the Rapper").id)


        Artist.create(name: 'Migos')
        Song.create(url: 'https://genius.com/Migos-narcos-lyrics', name: 'Narcos', artist_id:
          Artist.find_by_name("Migos").id)

          Artist.create(name: 'Outkast')
          Song.create(url: 'https://genius.com/Outkast-aquemini-lyrics', name: 'Aquemini', artist_id:
            Artist.find_by_name("Outkast").id)


            Artist.create(name: 'J.Cole')
            Song.create(url: 'https://genius.com/J-cole-foldin-clothes-lyrics', name: 'Foldin Clothes', artist_id:
              Artist.find_by_name("J.Cole").id)
